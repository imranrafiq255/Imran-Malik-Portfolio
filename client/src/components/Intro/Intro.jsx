...
import boy from "../../img/Imran Malik.png";
    ...
    <div className="Intro" id="Intro">
      <div className="i-left">
        ...
        <div className="i-icons">
          ...
          <a href="https://www.linkedin.com/in/muhammad-imran-rafiq-se?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
      ...
      <div className="i-right">
        <img src={Vector1} alt="" />
        <img src={Vector2} alt="" />
        <img src={boy} alt="" width={300} height={420} />
        {/* animation */}
        <motion.img
          initial={{ left: "-36%" }}
          whileInView={{ left: "-24%" }}
